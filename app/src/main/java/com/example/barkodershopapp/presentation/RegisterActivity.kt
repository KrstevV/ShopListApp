...
import com.example.barkodershopapp.databinding.ActivityRegisterBinding
import com.example.barkodershopapp.domain.userdataacc.userDataAcc
                ...
                if(confirmedPassword == password) {
                    auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener { task ->
                        ...
                        if (task.isSuccessful) {
                            ...
                            val users = userDataAcc(name, email, password, auth.currentUser!!.uid)
